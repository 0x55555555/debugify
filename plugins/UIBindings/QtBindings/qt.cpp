...
BONDAGE_MANUAL_CLASS_FUNCTIONS_BEGIN(Qt, QAction)
  ...
  BONDAGE_MANUAL_CLASS_METHOD(QAction, setEnabled),
  BONDAGE_MANUAL_CLASS_METHOD(QAction, isEnabled),
...
BONDAGE_MANUAL_CLASS_FUNCTIONS_BEGIN(Qt, QDialog)
  BONDAGE_MANUAL_CLASS_METHOD(QDialog, exec),
BONDAGE_MANUAL_CLASS_FUNCTIONS_END(Qt, QDialog)
BONDAGE_MANUAL_CLASS(Qt, BONDAGE_NULL_NAMESPACE, QDialog, QWidget)
...
BONDAGE_MANUAL_CLASS_FUNCTIONS_BEGIN(Qt, QDockWidget)
BONDAGE_MANUAL_CLASS_FUNCTIONS_END(Qt, QDockWidget)
BONDAGE_MANUAL_CLASS(Qt, BONDAGE_NULL_NAMESPACE, QDockWidget, QWidget)
