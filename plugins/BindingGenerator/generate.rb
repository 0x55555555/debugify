...
debugifyLibrary = Parser::Library.new("LldbDriver", "plugins/LldbDriver", "EXPORT_DEBUGIFY")
debugifyLibrary.addFiles('include', '*.h', true)
debugifyLibrary.addIncludePath("include")
debugifyLibrary.addDependency(eksLibrary)
debugifyLibrary.addDependency(manualLibrary)

debugifyLibrary.setAutogenPath(:cpp, "plugins/DebugifyBindings/src/autogen")
debugifyLibrary.setAutogenPath(:ruby, "plugins/DebugifyBindings/ruby/autogen")
...
class PathResolver
  ...
  def coreRequires()
    return [ "require_relative '../BindingsInternal'" ]
  end
end
